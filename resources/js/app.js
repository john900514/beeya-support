...
Vue.component('lead-form', require('./components/lead-form.vue').default);
...
Vue.component('search-result-component', require('./components/search-result-component.vue').default);
